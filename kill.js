  ...
  window.KillMy = function (cfg) {
    ...
    <div class="card" style="margin-top:24px;">
      ...
      <div class="btn-row center" style="margin-top:4px;">
        <a class="btn btn-text" href="https://calendly.com/markflournoy/chat-with-mark?utm_source=killmydeal&utm_medium=${cfg.slug}&utm_content=after_score&a1=${encodeURIComponent(cfg.name + ': ' + s.label.toLowerCase() + '. ' + s.meta)}" target="_blank" rel="noopener">Or book 20 minutes</a>
      </div>
    ...
    <div class="card" style="margin-top:24px;">
      ...
      <button class="btn btn-primary btn-lg btn-full" id="dmBtn" type="button" style="margin-top:14px;">Copy this &amp; DM me</button>
      <div class="btn-row center" style="margin-top:4px;">
        <a class="btn btn-text" href="https://calendly.com/markflournoy/chat-with-mark?utm_source=killmydeal&utm_medium=${cfg.slug}&utm_content=after_grill&a1=${encodeURIComponent(cfg.name + ': ' + s.label.toLowerCase() + '. ' + s.meta)}" target="_blank" rel="noopener">Or book 20 minutes</a>
      </div>
      <p class="fine" style="text-align:center;margin:4px 0 0;">Free either way. I answer LinkedIn faster than email.</p>
    </div>`);
