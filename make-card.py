...
CARDS = {
  ...
  'olr': dict(out='card-olr.jpg', wordmark='KILL MY OLR',
    headline=['Before you walk into OLR,', 'try to kill your case.'],
    dek='Five questions, then the room grills you. Grades the case, never the rep.',
    foot='For managers with a rep to defend. No names. No ratings.', url='killmydeal.com/olr',
    pillars=['RECEIPTS', 'OWNERSHIP', 'SCOPE', 'HOW', 'NEXT']),
  'brief': dict(out='card-brief.jpg', wordmark='KILL MY BRIEF',
    headline=["What's the question you're", 'hoping nobody asks?'],
    dek='Kill My Brief finds it before the meeting does. Five questions, then the room grills you.',
    foot='Any doc, deck or QBR. Nothing uploaded. Nothing stored.', url='killmydeal.com/brief',
